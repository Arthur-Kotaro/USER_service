-- ============================================================
-- Создание пользователей с bcrypt-хешами
-- Пароли: 
--   - Руководители: LeaderPass456!
--   - Сотрудники: TestPassword123!
-- ============================================================

-- Создание отделов (если ещё нет)
...
-- Цех №1 (руководитель LeaderPass456!, сотрудники TestPassword123!)
('Колосов Дмитрий Иванович', 'shop1.head@company.com', 
 '$2b$12$9tIfxWzJvUysrAdrB8weIeMqqOVM3cOZVwBfZRCnLqCwM6P5MmjRS', 
 'UPP_SHOP', NOW(), NOW(), NOW()),
('Маслов Игорь Петрович', 'master.shop1.1@shop.com', 
 '$2b$12$30pLh/sr1Pp5U7.7OsAMHO9OTbcoVXj2X7L5VUe.hh6KOH2A8NKNq', 
 'UPP_SHOP', NOW(), NOW(), NOW()),
...
-- Цех №2 (руководитель LeaderPass456!, сотрудники TestPassword123!)
...
-- КТО (руководитель LeaderPass456!, бюро и проработчики TestPassword123!)
...
-- Руководители проектов (TestPassword123!)
